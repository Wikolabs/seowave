...
export const metadata: Metadata = { title:"SEOWave — Contenu SEO automatise par IA", description:"100 articles SEO optimises livres chaque mois. Recherche de mots-cles, redaction E-E-A-T, publication et monitoring — entierement automatises." };
