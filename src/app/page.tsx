...
export default function DemoPage() {
  ...
  const t = lang === "fr" ? {
    ...
    gscMock: "Verif Search Console déclenchée (mode démo, pas de connexion réelle Google)",
    ahrefsMock: "Push vers Ahrefs Site Audit (mode démo, pas de connexion réelle Ahrefs)",
    cmsMock: "Modifications appliquées sur CMS (WordPress/Webflow/Shopify) (mode démo, pas de connexion réelle)",
  ...
  async function generate() {
    ...
    setLoading(true);
    try {
      const r = await fetch("/offers/seowave/demo/api/demo", {
        method: "POST",
